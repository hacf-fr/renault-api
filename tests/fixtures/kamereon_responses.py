    ...
    "vehicleLinks": [
        {
            ...
            "vehicleDetails": {
                ...
                "tcu": {"code": "TCU0G2", "label": "TCU VER 0 GEN 2", "group": "E70"},
                ...
                "radioType": {"code": "RAD37A", "label": "RADIO 37A", "group": "425"},
...
MOCK_VEHICLE_CHARGE_HISTORY_EMPTY = {
    "data": {"type": "Car", "id": TEST_VIN, "attributes": {"chargeSummaries": []}}
}
MOCK_VEHICLE_CHARGES_EMPTY = {
    "data": {"type": "Car", "id": TEST_VIN, "attributes": {"charges": []}}
}
MOCK_VEHICLE_CHARGING_SETTINGS_INVALID_UPSTREAM = MOCK_INVALID_UPSTREAM
MOCK_VEHICLE_COCKPIT = {
    "data": {"type": "Car", "id": TEST_VIN, "attributes": {"totalMileage": 49011.09}}
}
MOCK_VEHICLE_HVAC_STATUS = {
    "data": {
        "type": "Car",
        "id": TEST_VIN,
...
MOCK_VEHICLEACTIONS_CHARGING_START = {
    "data": {
        "type": "ChargingStart",
        "id": "guid",
...
MOCK_VEHICLEACTIONS_CHARGE_MODE = {
    "data": {
        "type": "ChargeMode",
        "id": "guid",
...
MOCK_VEHICLEACTIONS_CHARGE_SCHEDULE = {
    "data": {
        "type": "ChargeSchedule",
        "id": "guid",
...
MOCK_VEHICLEACTIONS_HVAC_START = {
    "data": {
        "type": "HvacStart",
        "id": "guid",
        "attributes": {
...
MOCK_VEHICLEACTIONS_HVAC_START_CANCEL = {
    "data": {
        "type": "HvacStart",
        "id": "guid",
...
# 400
MOCK_VEHICLEACTIONS_HVAC_START_INVALID_DATE = {
    "type": "FUNCTIONAL",
    "messages": [
        {
            "code": "err.func.400",
